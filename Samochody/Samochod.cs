...
namespace Samochody
{
    ...
    public class Samochod
    {
        ...
        public int RokProdukcji => rokProdukcji;
        ...
        {
            return string.Format("{0} {1} rok produkcji: {2}; pojemnoscść silnika: {3}; numer silnika {4}; właściciel: {5} {6}",
                Producent, Marka, RokProdukcji, Silnik.Pojemnosc, Silnik.NumerFabryczny, Wlasciciel.Imie, Wlasciciel.Nazwisko);
        }
        ...
        public override int GetHashCode()
        {
            return string.Format("{0} {1} {2} {3} {4}",
                Producent, Marka, RokProdukcji, Silnik.NumerFabryczny, Silnik.Pojemnosc).GetHashCode();
        }
    }
}
